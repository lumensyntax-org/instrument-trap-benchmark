...
\noindent\textit{Data availability: Benchmark specifications and evaluation methodology available upon request. Training data, model weights, and the epistemic constraint protocol are proprietary.}
